    ...
    return (
        <div className="">
            ...
            <div className="disclaimerSection">
                ...
                <p>When transporting a firearm or carrying into any area or state, it is your duty to contact local law enforcement or legal counsel regarding any questions.</p>
